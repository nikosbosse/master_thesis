...
``` {r forecast-paradigm, echo = FALSE, out.width = "100%", fig.cap = "Illustration of the forecast paradigm that states we should maximise sharpness subject to calibration. Shown are different predictive distributions that predict the true value at x = 0."}
...
For the median prediction^[To simplify the notation, we treat the the median as a 0% interval range represented by the pair of quantiles $(q_\frac{1}{2}, q_\frac{1}{2})$.], forecast has a sharpness of zero and the WIS is proportional to the MAE. 
